    ...
    public class UWTileMap : Loader
    {
        ...
        public static int NO_OF_LEVELS
        {
            get
            {
                ...
                {
                    case Game.Uw0: return 1;
                    case Game.Uw1: return 9;
                    case Game.Uw2: return 80;
                }
                return 1;
            }
        }
        ...
        public static void LoadTileMap(int newLevelNo, string datafolder, bool newGameSession = true)
        {
            ...
            {
                automap.automaps[newLevelNo] = new automap(newLevelNo, (int)GameConfig.GameSelected);
            }

            if (automapnote.automapsnotes[newLevelNo] == null)
            {
                automapnote.automapsnotes[newLevelNo] = new automapnote(newLevelNo, (int)GameConfig.GameSelected);
            }
