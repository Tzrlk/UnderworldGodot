                ...
                case 2: //3D models
                    {
                        ...
                        if ((Game.Uw2.IsSelected()) && (obj.classindex == 3))
                        {  //or item id 163
                        ...
                        if ((Game.Uw2.IsSelected()) && (obj.classindex == 7))
                        {  //or item id 359
                            obj.instance = bed.CreateInstance(parent, obj, name);
                            return false;
                        }
                        if ((Game.Uw2.IsSelected()) && (obj.classindex == 8))
                        {  //or item id 360
                            obj.instance = largeblackrockgem.CreateInstance(parent, obj, name);
                            return false;
                        }
                        if ((Game.Uw2.IsSelected()) && (obj.classindex == 9))
                        {  //or item id 361
