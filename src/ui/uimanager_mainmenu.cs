...
public partial class MainMenu : Node2D
{
    ...
    [Export]
    public Label[] SaveGamesNames = new Label[4];
    ...
    public override void _Ready()
    {
        ...
        {
            MainMenuBG.Texture = uimanager.instance.bitmaps.LoadImageAt(5);
        ...
        {
            uimanager.instance.bitmaps.UseRedChannel = true;
            MainMenuBG.Texture = uimanager.instance.bitmaps.LoadImageAt(BytLoader.OPSCR_BYT);
            MainMenuBG.Material = uimanager.instance.bitmaps.GetMaterial(BytLoader.OPSCR_BYT);
            var img = uimanager.instance.bitmaps.LoadImageAt(BytLoader.OPSCR_BYT);
            Palette.CurrentPalette = 6;
            uimanager.instance.bitmaps.UseRedChannel = false;
        }
    ...
    private void TurnButtonsOff()
    {
        for (int i = 0; i < 4; i++)
        {
            MainMenuButtons[i].Texture = uimanager.instance.grOptbtn.LoadImageAt(i * 2);
        }
    }
    ...
    private void ToggleMainMenuButtons(bool show)
    {
        for (int i = 0; i < 4; i++)
        {
            uimanager.EnableDisable(MainMenuButtons[i], show);
        }
    }
    ...
    private void HideSaves()
    {
        for (int i = 0; i < 4; i++)
        {
            uimanager.EnableDisable(SaveGamesNames[i], false);
        }
    }
    ...
    {
        TurnButtonsOff();
        MainMenuButtons[0].Texture = uimanager.instance.grOptbtn.LoadImageAt(1);
    }
    ...
    {
        TurnButtonsOff();
        MainMenuButtons[0].Texture = uimanager.instance.grOptbtn.LoadImageAt(0);
    }
    ...
    {
        TurnButtonsOff();
        MainMenuButtons[1].Texture = uimanager.instance.grOptbtn.LoadImageAt(3);
    }
    ...
    {
        TurnButtonsOff();
        MainMenuButtons[1].Texture = uimanager.instance.grOptbtn.LoadImageAt(2);
    }
    ...
    {
        TurnButtonsOff();
        MainMenuButtons[2].Texture = uimanager.instance.grOptbtn.LoadImageAt(5);
    }
    ...
    {
        TurnButtonsOff();
        MainMenuButtons[2].Texture = uimanager.instance.grOptbtn.LoadImageAt(4);
    }
    ...
    {
        TurnButtonsOff();
        MainMenuButtons[3].Texture = uimanager.instance.grOptbtn.LoadImageAt(7);
    }
    ...
    {
        TurnButtonsOff();
        MainMenuButtons[3].Texture = uimanager.instance.grOptbtn.LoadImageAt(6);
    }
        ...
        if (show)
        {
            for (int i = 1; i <= 4; i++)
            {
                ...
                if (File.Exists(path))
                {
                    ...
                    uimanager.EnableDisable(SaveGamesNames[i - 1], true);
                    SaveGamesNames[i - 1].Text = savename;
                }
                else
                {
                    uimanager.EnableDisable(SaveGamesNames[i - 1], false);
                }
            }
        }
        else
    ...
    private void _on_introduction_gui_input(InputEvent @event)
    {
        if (@event is InputEventMouseButton eventMouseButton && eventMouseButton.Pressed && eventMouseButton.ButtonIndex == MouseButton.Left)
        {
            GetTree().ChangeSceneToFile("res://scenes/IntroCutscene.tscn");
        }
    }
   ...
   public override void _Input(InputEvent @event)
        ...
        if (@event is InputEventKey keyinput)
        {
            if (keyinput.Pressed)
            {
                ...
                {//return to main menu
                    ToggleMainMenuButtons(true);
                    ToggleSaves(false);
                    GetTree().ChangeSceneToFile("res://scenes/CharGen.tscn");
                }                    
            }
        }
    }
    ...
    public static void ReturnToMainMenu()
    {
        ...
        uimanager.instance.GetTree().ChangeSceneToFile("res://scenes/MainMenu.tscn");
