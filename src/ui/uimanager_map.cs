...
namespace Underworld
{
    public partial class uimanager : Node2D
    {
        ...
        public static void DrawAutoMap(int level, int worldno)
        {
            ...
            {
                automap.automaps[blockno] = new automap(blockno, (int)GameConfig.GameSelected);
            }
            if (automap.automaps[blockno] == null)
            {
                return;
            ...
            {//load data if not ready.
                automapnote.automapsnotes[blockno] = new automapnote(blockno, (int)GameConfig.GameSelected);
            }
            if (automapnote.automapsnotes[blockno] != null)
            {
