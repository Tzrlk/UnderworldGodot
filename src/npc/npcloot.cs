...
namespace Underworld
{
    ...
    public partial class npc : objectInstance
    {
        ...
        public static void ValuableObjectLoot(uwObject critter)
        {
            ...
            { //spawn valuable
                int offset = 0; if ((byte)GameConfig.GameSelected != (byte)Game.Uw2) { offset = 3; }
                var valuable_type_var_1 = r.Next(0, 37 + offset - world * 3) - (30 + offset - world * 3);
                if (valuable_type_var_1 < 0) { valuable_type_var_1 = 0; }
                if ((valuable_type_var_1 == 1) && ((byte)GameConfig.GameSelected == (byte)Game.Uw2)) { valuable_type_var_1 = 0; }//make sure no storage crystal is dropped in UW2
